...
## Packages & Libraries
Backend: Laravel 12, HTTP Client (Http::get) for PokeAPI
Frontend: Next.js 16, React 18 hooks, CSS inline styles

## Run Project
Start pokedex-api(backend): php artisan serve
Start pokedex-frontend(frontend): npm run dev
Visit http://localhost:3000 to see the full app
